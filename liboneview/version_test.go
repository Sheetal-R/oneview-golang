...
func TestCheckVersion(t *testing.T) {
	...
	// package github.com/Sheetal-R/oneview-golang/liboneview (test)
	// 	imports github.com/docker/machine/drivers/oneview/ov
	// 	imports github.com/Sheetal-R/oneview-golang/liboneview
	//
	// FAIL	github.com/Sheetal-R/oneview-golang/liboneview [setup failed]
